...
class GastosGUI:
    ...
    def create_log_filter_panel(self, parent):
        ...
        apply_btn.grid(row=1, column=0, columnspan=2, sticky=tk.W, pady=(5, 0), padx=(0, 5))
        ...
        clear_btn.grid(row=1, column=2, sticky=tk.W, pady=(5, 0), padx=(0, 5))
    ...
    def create_complete_log_display(self, parent):
        ...
        _log_font = tkfont.Font(family="Consolas", size=9)
